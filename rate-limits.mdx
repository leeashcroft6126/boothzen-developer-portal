...
The current numbers for any given key are always authoritative in the response headers — read `RateLimit-Limit` on any successful call rather than hard-coding the default. See the **API Reference** tab for live "Try it" calls.
